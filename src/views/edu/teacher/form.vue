    ...
    <el-form label-width="120px">
      ...
      @crop-upload-success：上传成功后的回调 -->
        <image-cropper
          ...
          :height="300"
          :key="imagecropperKey"
          :url="BASE_API+'/user/user/avatar/upload'"
          field="file"
          @close="close"
...
const defaultFrom = {
  ...
  career: '',
  intro: '',
  avatar: ' https://cloudstudy-avatar.oss-cn-hangzhou.aliyuncs.com/avatar/2021/02/26/ec72ffef-137f-4439-92fe-af0569efde2f.png'
}
