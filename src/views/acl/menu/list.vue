      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button
            ...
            type="success"
            size="mini"
            @click="() => {dialogFormVisible = true, menu.pid = scope.row.id,this.menu = this.emptyMenu}">添加菜单
          </el-button>
          <el-button
            v-if="scope.row.level == 3 &&  hasPerm('permission.add')"
            type="success"
            size="mini"
            @click="() => {dialogPermissionVisible = true, permission.pid = scope.row.id,this.permission = this.emptyPermission}">添加功能
          </el-button>
          <el-button
          ...
          <el-button
            ...
            size="mini"
            icon="el-icon-delete"
            @click="() => remove(scope.row)" v-if="hasPerm('permission.remove')"></el-button>
        </template>
      </el-table-column>
    </el-table>
