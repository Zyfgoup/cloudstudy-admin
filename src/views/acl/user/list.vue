<template>
  <div class="app-container">
    ...
    <!-- 工具条 -->
    <div>
      <el-button  type="danger" size="mini" plain="true" @click="addUser()">添加</el-button>
      <el-button  type="danger" size="mini" plain="true" @click="removeRows()">批量删除</el-button>
    </div>
    ...
    <el-table
      ...
      <el-table-column label="操作"  align="center">
        <template slot-scope="scope">
          ...
          <el-button v-if="scope.row.isDisabled===0" type="info"  size="mini"  @click="freeze(scope.row.id)">冻结</el-button>
          <el-button v-if="scope.row.isDisabled===1" type="info"  size="mini"  @click="unfreeze(scope.row.id)">解冻</el-button>
