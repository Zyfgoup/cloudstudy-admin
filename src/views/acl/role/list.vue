<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="roleName" label="角色名称" width="200px" align="center" />
      <el-table-column prop="createTime" label="创建时间" width="260px" align="center"/>
      <el-table-column prop="remark" label="备注" width="400px" align="center"/>
