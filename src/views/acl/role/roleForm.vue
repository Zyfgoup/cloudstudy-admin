...
export default {
  ...
  methods: {
    ...
    save(){
      ...
      var pids = this.$refs.tree.getHalfCheckedKeys()
      var permisssionIds = ids.concat(pids).join(",");
      console.log(permisssionIds);
      //vue elementUI tree树形控件获取父节点ID的实例
      //node_modules\element-ui\lib\element-ui.common.js
      //25348行修改源码
      menu.doAssign(this.roleId, permisssionIds).then(response => {
